...
from apps.routers.first_page_module import router as first_page_router
from apps.routers.second_page_module import router as second_page_router
from apps.routers.third_page_module import router as third_page_router
from fastapi import FastAPI
